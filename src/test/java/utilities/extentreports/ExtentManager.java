 ...
 * Required class for generating Extent Reports. Add/Modify/Remove values only if needed. */
public class ExtentManager {
    ...
    public static synchronized ExtentReports createExtentReports() {
        ...
        reporter.config().setJs("document.getElementsByClassName('col-md-6')[1].style.setProperty('display','none');"); // To
                                                                                                                        // remove
                                                                                                                        // unnecessary
                                                                                                                        // chart
                                                                                                                        // shown
